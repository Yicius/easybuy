            ...
            <div class="list_c">
                ...
                <ul class="cate_list">
                    <c:forEach items="${pList}" var="pList">
                        <li>
                            <div class="img">
                                <a href="${ctx}/product?action=queryProductDetail&id=${pList.id}"><img src="${ctx}/files/${pList.fileName}" width="210" height="185" /></a>
                            </div>
                            <div class="price">
                            ...
                            <div class="carbg">
                                <a href="#" class="ss" onclick="addFavourite('${pList.id}')">收藏</a>
                                <a href="#" class="j_car" onclick="addCart('${pList.id}',1)">加入购物车</a>
                            </div>
                        </li>
                    </c:forEach>
